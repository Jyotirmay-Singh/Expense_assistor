---
description: Create a spec file and feature branch for the next FinCheck step
...
FinCheck expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the FinCheck roadmap.
